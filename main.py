...
async def photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for n in nums:
        users[key]["history"].append(to_tx(n))

    await update.message.reply_text(f"Đã lấy {len(nums)} kết quả từ ảnh")
