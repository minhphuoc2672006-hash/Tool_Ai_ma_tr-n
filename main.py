...
# ===== AI =====
def ai_predict(user):
    # Dựa trên chiến thuật tốt nhất hiện tại
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("🤖 AI PRO TÀI/XỈU\n/setmoney 500000\n/reset để reset toàn bộ dữ liệu")
...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ===== SUY LUẬN CHIẾN THUẬT TỐT NHẤT MỖI LẦN =====
    user["strategy"] = evaluate_strategies(user["history"])
