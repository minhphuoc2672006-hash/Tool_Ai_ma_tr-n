...
async def reset(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("🔄 Reset history (giữ tiền & lãi)")
...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for num in nums:
        ...
        # ===== GẤP THẾP =====
        base = int(user["money"] * 0.05)  # 5% vốn
        bet = base * user["step"]
