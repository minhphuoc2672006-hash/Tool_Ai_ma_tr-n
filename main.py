...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ===== CHỌN CHIẾN THUẬT NGẪU NHIÊN + RANDOM NHẸ =====
    new_strategy = random.choice(STRATEGIES)
    user["strategy"] = new_strategy
    pred = run_strategy(new_strategy, user["history"])
    # random nhẹ (20%) thay đổi dự đoán
    ...
    msg = (
        "━━━━━━━━━━━━━━\n"
        "🤖 AI PHÂN TÍCH TOÀN BỘ LỊCH SỬ (Chiến thuật ngẫu nhiên)\n"
        "━━━━━━━━━━━━━━\n"
